...
export async function LegalPrivacyBody({ locale }: { locale: string }) {
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>{t.rich("s2_li3", rich)}</li>
        <li>{t.rich("s2_li4", rich)}</li>
      </ul>
      ...
      <p>{t("s4_intro")}</p>
      <ul>
        <li>{t.rich("s4_li1", rich)}</li>
        <li>{t.rich("s4_li2", rich)}</li>
        <li>{t.rich("s4_li3", rich)}</li>
        <li>{t.rich("s4_li4", rich)}</li>
        <li>{t.rich("s4_li5", rich)}</li>
      </ul>
      <p>{t("s4_outro")}</p>
